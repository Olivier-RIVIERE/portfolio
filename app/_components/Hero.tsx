  ...
  return (
    <Section className="flex max-md:flex-col items-start gap-4">
      ...
      <div className="flex-[2] max-md:m-auto ml-auto">
        <Image src="/images/img-olivier.jpg" width={300} height={300} className="rounded-full h-auto max-w-xs max-md:w-56 m-auto shadow-xl transition-all duration-500 hover:scale-110 hover:shadow-[0_0_20px_rgba(255,255,255,0.6)]" alt="Olivier RIVIERE" />
