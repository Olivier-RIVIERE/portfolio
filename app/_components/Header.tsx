    ...
    <header className="sticky z-10 top-0 py-4 bg-card">
      <Section className="flex items-center">
        ...
        <div className="ml-auto hidden md:flex items-center gap-2">
          <Link href="/" className={cn(buttonVariants({ variant: "ghost" }), "h-8 px-3")}>
            Accueil
          </Link>
        ...
        <div className="ml-auto md:hidden">
          <Sheet>
            <SheetTrigger className={cn(buttonVariants({ variant: "ghost" }), "size-9 p-0")}
              aria-label="Ouvrir le menu" title="Menu">
