  ...
  return (
    <Section className="flex flex-col items-start gap-4">
      ...
      {/* <div className="flex flex-col gap-2 justify-center">
        ...
        <h3 className="text-2xl font-semibold tracking-tight text-primary mb-2">MySQL</h3>
        <p className="text-sm text-muted-foreground"><Code>MySQL</Code> est un système de gestion de bases de données performant et largement utilisé. Sa fiabilité en fait un choix essentiel pour des projets web professionnels.</p>
      </div> */}
    </Section >
  )
}
